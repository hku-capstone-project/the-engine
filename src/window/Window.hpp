...
struct AppWindow {
  ...
  AppWindow(char const *window_name, u32 sx = 800, u32 sy = 600) : width{sx}, height{sy} {
    ...
    glfw_window_ptr = glfwCreateWindow(static_cast<i32>(width), static_cast<i32>(height),
