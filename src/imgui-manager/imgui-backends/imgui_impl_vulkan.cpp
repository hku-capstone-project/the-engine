...
void ImGui_ImplVulkan_RenderDrawData(ImDrawData *draw_data, VkCommandBuffer command_buffer,
    ...
    if (draw_data->TotalVtxCount > 0) {
        ...
        size_t vertex_size = AlignBufferSize(draw_data->TotalVtxCount * sizeof(ImDrawVert),
                                             bd->BufferMemoryAlignment);
        size_t index_size  = AlignBufferSize(draw_data->TotalIdxCount * sizeof(ImDrawIdx),
                                             bd->BufferMemoryAlignment);
...
bool ImGui_ImplVulkan_CreateDeviceObjects() {
    ...
    ImGui_ImplVulkan_CreatePipeline(v->Device, v->Allocator, v->PipelineCache, v->RenderPass,
                                    v->MSAASamples, &bd->Pipeline, v->Subpass);
...
//     reinterpret_cast<PFN_vkCmdBeginRenderingKHR>(loader_func("vkCmdBeginRenderingKHR",
//     user_data)); ImGuiImplVulkanFuncs_vkCmdEndRenderingKHR =
...
bool ImGui_ImplVulkan_Init(ImGui_ImplVulkan_InitInfo *info) {
    ...
    if (info->UseDynamicRendering == false) IM_ASSERT(info->RenderPass != VK_NULL_HANDLE);
